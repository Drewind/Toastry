...
/**
 * Utility class to help translate component values into strings.
 * @see <a href="https://stackoverflow.com/questions/40775607/java-set-get-all-components-text-in-a-jframe">Stackoverflow</a>
 */
public class SwingObjectText {
    /**
     * Converts a JComponent's input object into a String.
     * @param object object
     * @return String value
     */
    public static String getSwingObjectText(Object object) {
        ...
        if (object instanceof javax.swing.JComboBox) {
            return ((javax.swing.JComboBox<?>) object).getSelectedItem().toString();
        }
