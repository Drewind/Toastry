 ...
 * only to integers and decimals. Since this class extends DocumentFilter,
 ...
 * for original code.
 */
public class InputDecimalFilter extends DocumentFilter {
    @Override
    ...
    public void replace(FilterBypass fb, int offset, int length, String text,
        ...
        if (test(sb.toString()) && !text.contains("d")) {
