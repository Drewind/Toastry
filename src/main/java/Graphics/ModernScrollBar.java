 ...
 * Credit to <a href="https://stackoverflow.com/users/5476882/philipp-danner">Philipp Danner</a>
 * for the code.
 *
 * @see <a href="https://stackoverflow.com/questions/16373459/java-jscrollbar-design">answer</a> on Stackoverflow
 * original code.
 */

public class ModernScrollBar extends JScrollPane {
    ...
    public ModernScrollBar(Component view) {
        this(view, VERTICAL_SCROLLBAR_AS_NEEDED, HORIZONTAL_SCROLLBAR_AS_NEEDED);
    }

    public ModernScrollBar(int vsbPolicy, int hsbPolicy) {
        this(null, vsbPolicy, hsbPolicy);
    }

    public ModernScrollBar(Component view, int vsbPolicy, int hsbPolicy) {
        setBorder(null);
    ...
    private static class ModernScrollBarUI extends BasicScrollBarUI {
        ...
        public ModernScrollBarUI(ModernScrollBar sp) {
            this.sp = sp;
        }
